...
Load the GAP package LocalizeRingForHomalg into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("localizeringforhomalg"), banner; OnlyNeeded=only_needed)
    if res != true
