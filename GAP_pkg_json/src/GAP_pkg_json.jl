...
A wrapper for the GAP package json 2.1.1.
"""
module GAP_pkg_json
...
Load the GAP package json into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("json"), banner; OnlyNeeded=only_needed)
    if res != true
