...
A wrapper for the GAP package JupyterViz 1.5.6.
"""
...
Load the GAP package JupyterViz into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("jupyterviz"), banner; OnlyNeeded=only_needed)
    if res != true
