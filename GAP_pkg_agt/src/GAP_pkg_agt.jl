...
A wrapper for the GAP package AGT 0.3.1.
"""
module GAP_pkg_agt
...
Load the GAP package AGT into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("agt"), banner; OnlyNeeded=only_needed)
    if res != true
