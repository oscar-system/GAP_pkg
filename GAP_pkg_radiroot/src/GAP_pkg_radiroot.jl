...
A wrapper for the GAP package RadiRoot 2.9.
"""
...
Load the GAP package RadiRoot into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("radiroot"), banner; OnlyNeeded=only_needed)
    if res != true
