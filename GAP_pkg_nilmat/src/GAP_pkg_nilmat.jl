...
A wrapper for the GAP package Nilmat 1.4.2.
"""
...
Load the GAP package Nilmat into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("nilmat"), banner; OnlyNeeded=only_needed)
    if res != true
