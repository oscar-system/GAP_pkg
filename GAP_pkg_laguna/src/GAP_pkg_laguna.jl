...
A wrapper for the GAP package LAGUNA 3.9.7.
"""
...
Load the GAP package LAGUNA into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("laguna"), banner; OnlyNeeded=only_needed)
    if res != true
