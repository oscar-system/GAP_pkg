...
A wrapper for the GAP package fwtree 1.3.
"""
...
Load the GAP package fwtree into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("fwtree"), banner; OnlyNeeded=only_needed)
    if res != true
