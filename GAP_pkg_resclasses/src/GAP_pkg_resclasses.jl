...
A wrapper for the GAP package ResClasses 4.7.3.
"""
...
Load the GAP package ResClasses into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("resclasses"), banner; OnlyNeeded=only_needed)
    if res != true
