...
A wrapper for the GAP package ITC 1.5.1.
"""
module GAP_pkg_itc
...
Load the GAP package ITC into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("itc"), banner; OnlyNeeded=only_needed)
    if res != true
