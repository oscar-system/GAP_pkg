...
A wrapper for the GAP package DeepThought 1.0.6.
"""
...
Load the GAP package DeepThought into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("deepthought"), banner; OnlyNeeded=only_needed)
    if res != true
