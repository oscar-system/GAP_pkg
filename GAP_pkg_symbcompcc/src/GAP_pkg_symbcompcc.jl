...
A wrapper for the GAP package SymbCompCC 1.3.2.
"""
...
Load the GAP package SymbCompCC into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("symbcompcc"), banner; OnlyNeeded=only_needed)
    if res != true
