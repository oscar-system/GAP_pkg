...
Load the GAP package GeneralizedMorphismsForCAP into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("generalizedmorphismsforcap"), banner; OnlyNeeded=only_needed)
    if res != true
