...
A wrapper for the GAP package ExamplesForHomalg 2022.11-01.
"""
...
Load the GAP package ExamplesForHomalg into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("examplesforhomalg"), banner; OnlyNeeded=only_needed)
    if res != true
