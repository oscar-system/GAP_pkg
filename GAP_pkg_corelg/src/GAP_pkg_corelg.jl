...
A wrapper for the GAP package CoReLG 1.56.
"""
...
Load the GAP package CoReLG into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("corelg"), banner; OnlyNeeded=only_needed)
    if res != true
