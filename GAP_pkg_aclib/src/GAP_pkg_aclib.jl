...
A wrapper for the GAP package AClib 1.3.2.
"""
...
Load the GAP package AClib into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("aclib"), banner; OnlyNeeded=only_needed)
    if res != true
