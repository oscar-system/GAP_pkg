...
A wrapper for the GAP package classicpres 1.22.
"""
...
Load the GAP package classicpres into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("classicpres"), banner; OnlyNeeded=only_needed)
    if res != true
