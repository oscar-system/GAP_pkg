...
A wrapper for the GAP package MapClass 1.4.6.
"""
...
Load the GAP package MapClass into GAP. Use `banner` to control
...
function load(; banner::Bool=true, only_needed::Bool=true)
    res = GAP.Globals.LoadPackage(GapObj("mapclass"), banner; OnlyNeeded=only_needed)
    if res != true
